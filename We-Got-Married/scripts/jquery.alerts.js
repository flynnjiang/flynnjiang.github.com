...
(function($) {
	...
	$.alerts = {
		...
		_show : function(title, msg, value, type, callback) {
			...
			case 'alert':
				$("#popup_message").after(
						'<div id="popup_panel"><table width="100%"><tr><td style="padding-left:100px"><input type="button" value="'
								+ $.alerts.okButton
								+ '" id="popup_ok" /></td></tr></table></div>');
			...
			case 'confirm':
				$("#popup_message")
						.after(
								'<div id="popup_panel"><table width="100%"><tr><td width="50%" align=right style="padding-right:5px;padding-left:80px"><input type="button" value="'
										+ $.alerts.okButton
										+ '" id="popup_ok" /></td><td align=left><input type="button" value="'
										+ $.alerts.cancelButton
										+ '" id="popup_cancel" /></td></tr></table></div>');
				$("#popup_ok").click(function() {
					$.alerts._hide();
					if (callback)
						callback(true);
